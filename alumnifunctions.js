...
//switch case 4
export function deleteLast (studentsArray) {
    studentsArray.length = studentsArray.length - 1;
    return studentsArray;
};

//switch case 5
export function deleteRandom (studentsArray) {
...
//switch case 7 and
//switch case 13
export function getFemalesList (studentsArray) {
    let females = [];
...
//switch case 8
export function checkAllStudentsAreFemale (studentsArray) {
    let isTrue = studentsArray.every((student) => student.gender === "female");
    return console.log(isTrue);
};

//switch case 9
export function getYoungStudents (studentsArray) {
    let youngStudents = [];
    for (let index = 0; index < studentsArray.length; index++) {
...
//switch case 10
export function addRandomStudent (studentsArray) {
...
//switch case 11
export function getYoungestStudent (studentsArray) {
...
//switch case 12 and
//switch case 13
export function getAgeAverage (studentsArray) {
    let studentsAge = [];
    for (let index = 0; index < studentsArray.length; index++) {
...
//switch case 14
export function addGrades (studentsArray) {
    for (let index = 0; index < studentsArray.length; index++) {
...
//switch case 16
export function getBestStudents (studentsArray) {
...
export function sumGrades (student) {
    return sum(student.examScores);
};

//switch case 17
export function getStudentsNamesAndGradeAverage (studentsArray) {
    for (let index = 0; index < studentsArray.length; index++) {
        console.log(
...
export function meanAverage (array) {
    return +Math.round((sum(array) / array.length + Number.EPSILON) * 100) / 100;
};

//switch case 18
export function addPointsToAll (studentsArray) {
    for (let index = 0; index < studentsArray.length; index++) {
        addGradePoint(studentsArray[index].examScores);
    }
};
export function addGradePoint (grades) {
    if (grades.length === 0) {
        grades.push(10);
    } else {
